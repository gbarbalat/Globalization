# This performs the analysis for different trimming levels
...
#cluster your analysis
{
  ...
  try_this <- function(x, list_files) {
    ...
    return(list(psi_1_t1, psi_2_t1,psi_3_t1,psi_4_t1,
                results_MSM_categ_t1,
                psi_1_t2, psi_2_t2,psi_3_t2,psi_4_t2,
                results_MSM_categ_t2,
...
save(psi_results_data,
     file="results_lmtp_Quality_sensit_trim.RData")
